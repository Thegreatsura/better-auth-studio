...
const versionHistory = [
  ...
  {
    version: "v1.0.79-beta.66",
    date: "2025-10-XX",
    description:
      "Comprehensive framework support for self-hosting. Better Auth Studio now supports 10 major web frameworks (Next.js, Express, Hono, Elysia, SvelteKit, SolidStart, TanStack Start, Astro, Remix, Nuxt) with seamless integration for production deployments. Added environment variable support for admin emails and mobile-responsive documentation.",
  },
  {
    version: "v1.0.80-beta.1",
    date: "2025-12-30",
    description:
  ...
  },
  {
    version: "v1.0.22",
    date: "2025-10-29",
    description: "Release with enhanced session management and improved user interface components.",
  },
  {
    version: "v1.0.21",
    date: "2025-10-28",
  ...
  },
  {
    version: "v1.0.15",
    date: "2025-10-25",
    description: "Enhanced user interface with improved navigation and performance optimizations.",
  },
  {
    version: "v1.0.14",
    date: "2025-10-20",
    description: "Added comprehensive session management and organization features.",
  },
  {
    version: "v1.0.13",
    date: "2025-10-15",
    description: "Initial stable release with core authentication management capabilities.",
  },
];
      ...
      <div className="space-y-8 relative">
        ...
        <section>
          <PixelCard variant="highlight" className="relative">
            ...
            <p className="text-sm font-light tracking-tight text-white/70 mb-4 pt-4">
              Database event ingestion support. Better Auth Studio now supports comprehensive event
              ingestion across multiple database clients including PostgreSQL, SQLite, Prisma,
              Drizzle ORM, and ClickHouse with automatic table creation and seamless event capture.
            </p>
            <Link
              href="/v/1.1.1"
            ...
            <div className="space-y-3">
              <h4 className="font-light tracking-tight text-white flex items-center">
                <DatabaseIcon />
              ...
              <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                <li className="flex items-center">
                  <ChevronIcon />
                  PostgreSQL, SQLite, Prisma, Drizzle ORM, and ClickHouse support with automatic
                  table creation and event capture.
                </li>
              </ul>
              <h4 className="font-light tracking-tight text-white flex items-center mt-4">
                <RocketIcon />
              ...
              <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                <li className="flex items-center">
                  <ChevronIcon />
                  Support for 10 major frameworks: Next.js, Express, Hono, Elysia, SvelteKit,
                  SolidStart, TanStack Start, Astro, Remix, and Nuxt.
                </li>
              </ul>
              <h4 className="font-light tracking-tight text-white flex items-center mt-4">
                <SettingsIcon />
              ...
              <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                <li className="flex items-center">
                  <ChevronIcon />
                  Framework-agnostic self-hosting with role-based access control, email allowlists,
                  custom base paths, and production-ready deployment patterns.
                </li>
              </ul>
              <h4 className="font-light tracking-tight text-white flex items-center mt-4">
                <GlobeIcon />
        ...
        <section>
          <PixelCard variant="highlight" className="relative">
            ...
            <p className="text-sm font-light tracking-tight text-white/70 mb-4 pt-4">
              Added Hono and Elysia framework support for self-hosting. Better Auth Studio now
              supports integration with Hono.js and Elysia.js frameworks, expanding framework
              compatibility beyond Next.js and Express.
            </p>
            <div className="space-y-3">
              <h4 className="font-light tracking-tight text-white flex items-center">
                <ChevronIcon />
              ...
              <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                <li className="flex items-center">
                  <ChevronIcon />
                  <strong className="text-white/90 mr-2">Hono.js Support:</strong> Full integration
                  with Hono framework using the{" "}
                  <code className="text-white/80 bg-white/10 px-1">better-auth-studio/hono</code>{" "}
                  adapter
                </li>
                <li className="flex items-center">
                  <ChevronIcon />
                  <strong className="text-white/90 mr-2">Elysia.js Support:</strong> Native support
                  for Elysia framework optimized for Bun runtime via{" "}
                  <code className="text-white/80 bg-white/10 px-1">better-auth-studio/elysia</code>{" "}
                  adapter
                </li>
                <li className="flex items-center">
                  <ChevronIcon />
                  Universal request/response pattern ensures consistent behavior across all
        ...
        <section>
          <PixelCard variant="highlight" className="relative">
            ...
            <p className="text-sm font-light tracking-tight text-white/70 mb-4 pt-4">
              Beta release with self-hosting support. Better Auth Studio can now be embedded
              directly into your application for production use. Full support for Next.js App Router
              and Express.js integration with automatic route generation.
            </p>
            <div className="space-y-3">
              <h4 className="font-light tracking-tight text-white flex items-center">
                <ChevronIcon />
              ...
              <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                ...
                <li className="flex items-center">
                  <ChevronIcon />
                  Full support for Next.js App Router and seamless integration with Express.js
                  applications
                </li>
                <li className="flex items-center">
                  <ChevronIcon />
              ...
              <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                <li className="flex items-center">
                  <ChevronIcon />
                  Fixed adapter resolution, auth config loading, and database schema loading for all
                  endpoints
                </li>
                <li className="flex items-center">
                  <ChevronIcon />
                  Updated analytics, stats, users, sessions, and providers endpoints for self-hosted
                  compatibility
                </li>
                <li className="flex items-center">
                  <ChevronIcon />
              ...
              <div className="bg-black/50 border border-white/10 p-3 mt-4">
                <p className="text-xs font-light tracking-tight text-white/70">
                  <strong className="text-white/90">Note:</strong> Self-hosting is currently in
                  beta. Please report any issues on GitHub. For Next.js deployments, ensure you add
                  the <code className="text-white/80 px-1">outputFileTracingIncludes</code>{" "}
                  configuration to your <code className="text-white/80 px-1">next.config.ts</code>.
                </p>
              </div>
            </div>
          </PixelCard>
            ...
            <div className="absolute -top-10 left-0">
              <h3 className="relative text-[12px] font-light uppercase tracking-tight text-white/90 border border-white/20 bg-[#0a0a0a] px-2 py-[6px] overflow-hidden">
                ...
                <span className="relative z-10 inline-flex gap-[2px] items-center">
                  ...
                  Self-Hosting Support (Beta){" "}
                  <span className="text-white/50 ml-2">/ 2025-12-24</span>
                </span>
              </h3>
            </div>
            <div className="space-y-4 pt-4">
              <div>
                <h4 className="font-light tracking-tight mb-2 text-white flex items-center">
                  <RocketIcon />
                  Self-Hosting Feature
                </h4>
                <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                  <li className="flex items-center">
                    <ChevronIcon />
                    Better Auth Studio can now be embedded directly into your application for
                    production use
                  </li>
                  <li className="flex items-center">
                    <ChevronIcon />
                    Full support for Next.js App Router and seamless integration with Express.js
                    applications, both with automatic route generation
                  </li>
                  <li className="flex items-center">
                    <ChevronIcon />
                    Role-based and email-based access control for secure studio access
              ...
              <div>
                ...
                <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                  <li className="flex items-center">
                    <ChevronIcon />
                    Fixed adapter resolution in self-hosted mode for sign-in and user management
                    endpoints
                  </li>
                  <li className="flex items-center">
                    <ChevronIcon />
                  ...
                  <li className="flex items-center">
                    <ChevronIcon />
                    Updated analytics, stats, users, sessions, and providers endpoints for
              ...
              <div>
                ...
                <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                  <li className="flex items-center">
                    <ChevronIcon />
                    Added required{" "}
                    <code className="text-white/80 px-1">outputFileTracingIncludes</code>{" "}
              ...
              <div>
                ...
                <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                  <li className="flex items-center">
                    ...
                    <code className="text-white/80 px-1">preloadedAuthOptions</code> in self-hosted
                    mode
                  </li>
                  <li className="flex items-center">
                    <ChevronIcon />
                    Enhanced <code className="text-white/80 px-1">getAuthData</code> function to
                    support preloaded adapters
                  </li>
                  <li className="flex items-center">
                    <ChevronIcon />
            ...
            <div className="absolute -top-10 left-0">
              <h3 className="relative text-[12px] font-light uppercase tracking-tight text-white/90 border border-white/20 bg-[#0a0a0a] px-2 py-[6px] overflow-hidden">
                ...
                <span className="relative z-10 inline-flex gap-[2px] items-center">
                  ...
                  Email Editor & Database Enhancements{" "}
                  <span className="text-white/50 ml-2">/ 2025-11-12</span>
                </span>
              </h3>
            </div>
            <div className="space-y-4 pt-4">
              <div>
                ...
                <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                  ...
                  <li className="flex items-center">
                    <ChevronIcon />
                    Template testing functionality with dynamic placeholder replacement and Resend
                    integration
                  </li>
                  <li className="flex items-center">
                    <ChevronIcon />
                  ...
                  <li className="flex items-center">
                    <ChevronIcon />
                    Field simulator for testing email templates with custom values before deployment
                    along with Resend in
                  </li>
                  <li className="flex items-center">
                    <ChevronIcon />
              ...
              <div>
                ...
                <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                  ...
                  <li className="flex items-center">
                    <ChevronIcon />
                    Dynamic schema loading from Better Auth context with plugin-aware table
                    detection
                  </li>
                  <li className="flex items-center">
                    <ChevronIcon />
            ...
            <div className="absolute -top-10 left-0">
              <h3 className="relative text-[12px] font-light uppercase tracking-tight text-white/90 border border-white/20 bg-[#0a0a0a] px-2 py-[6px] overflow-hidden">
                ...
                <span className="relative z-10 inline-flex gap-[2px] items-center">
                  ...
                  Email Enhancements & Password Tool{" "}
                  <span className="text-white/50 ml-2">/ 2025-10-31</span>
                </span>
              </h3>
            </div>
            <div className="space-y-4 pt-4">
              <div>
                ...
                <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                  ...
                  <li className="flex items-center">
                    <ChevronIcon />
                    Field simulator for real-time preview of email templates with dynamic
                    placeholders
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                  ...
                  <li className="flex items-center">
                    <ChevronIcon />
                    Checks for length, uppercase, lowercase, numbers, special characters, and common
                    patterns
                  </li>
                  <li className="flex items-center">
                    <ChevronIcon />
              ...
              <div>
                ...
                <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                  <li className="flex items-center">
                    <ChevronIcon />
                    Dynamic count badges for Database (schema count), Emails (template count), and
                    Tools (total tools)
                  </li>
                  <li className="flex items-center">
                    <ChevronIcon />
            ...
            <div className="absolute -top-10 left-0">
              <h3 className="relative text-[12px] font-light uppercase tracking-tight text-white/90 border border-white/20 bg-[#0a0a0a] px-2 py-[6px] overflow-hidden">
                ...
                <span className="relative z-10 inline-flex gap-[2px] items-center">
                  ...
                  Dashboard Overhaul & Tool Suite{" "}
                  <span className="text-white/50 ml-2">/ 2025-11-08</span>
                </span>
              </h3>
            </div>
            <div className="space-y-4 pt-4">
              <div>
                ...
                <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                  <li className="flex items-center">
                    <ChevronIcon />
                    Period controls wired to analytics endpoints for organizations, teams, and
                    subscriptions with custom range support
                  </li>
                  <li className="flex items-center">
                    <ChevronIcon />
                    Refined stat cards with live percentages, hover tooltips, and constraint-aware
                    chart tooltips
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                  <li className="flex items-center">
                    <ChevronIcon />
                    Test OAuth flow with provider selection modal, Better Auth state validation,
                    popup orchestration, and account polling
                  </li>
                  <li className="flex items-center">
                    <ChevronIcon />
                    Run Migration dialog featuring Clerk blueprint, syntax-highlighted custom
                    editor, and Coming Soon placeholders
                  </li>
                  <li className="flex items-center">
                    <ChevronIcon />
                    Test Database connectivity via `/api/database/test` with inline sample row
                    preview and concise terminal logs
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="absolute -top-10 left-0">
              <h3 className="relative text-[12px] font-light uppercase tracking-tight text-white/90 border border-white/20 bg-[#0a0a0a] px-2 py-[6px] overflow-hidden">
                ...
                <span className="relative z-10 inline-flex gap-[2px] items-center">
                  ...
                  Shadcn UI & Admin Functionality{" "}
                  <span className="text-white/50 ml-2">/ 2025-10-09</span>
                </span>
              </h3>
            </div>
            <div className="space-y-4 pt-4">
              <div>
                ...
                <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                  ...
                  <li className="flex items-center">
                    <ChevronIcon />
                    DateRangePicker component for advanced date filtering with auto-close
                    functionality
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                  <li className="flex items-center">
                    <ChevronIcon />
                    Dynamic filter system with Email Verified, Banned Status, Created Date, and Role
                    filters
                  </li>
                </ul>
              </div>
            ...
            <div className="absolute -top-10 left-0">
              <h3 className="relative text-[12px] font-light uppercase tracking-tight text-white/90 border border-white/20 bg-[#0a0a0a] px-2 py-[6px] overflow-hidden">
                ...
                <span className="relative z-10 inline-flex gap-[2px] items-center">
                  ...
                  <span className="text-white/50 ml-2">/ 2025-10-28</span>
                </span>
              </h3>
            </div>
            <div className="space-y-4 pt-4">
            ...
            <div className="absolute -top-10 left-0">
              <h3 className="relative text-[12px] font-light uppercase tracking-tight text-white/90 border border-white/20 bg-[#0a0a0a] px-2 py-[6px] overflow-hidden">
                ...
                <span className="relative z-10 inline-flex gap-[2px] items-center">
                  ...
                  <span className="text-white/50 ml-2">/ 2025-10-30</span>
                </span>
              </h3>
            </div>
            <div className="space-y-4 pt-4">
              ...
              <div>
                <h4 className="font-light tracking-tight mb-2 text-white">
            ...
            <div className="space-y-4 pt-4">
              <div>
                ...
                <ul className="list-none space-y-2 text-sm font-light tracking-tight text-white/70 ml-4">
                  <li className="flex items-center">
                    <ChevronIcon />
                    Added CSV export functionality for Users page with ID, name, email, verification
                    status, and timestamps
                  </li>
                  <li className="flex items-center">
                    <ChevronIcon />
                    Added CSV export functionality for Organizations page with ID, name, slug, and
                    timestamps
                  </li>
                  <li className="flex items-center">
                    <ChevronIcon />
