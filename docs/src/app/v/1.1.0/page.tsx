    ...
    <div className="bg-[#0a0a0a] text-white h-screen overflow-hidden overflow-x-hidden font-sans selection:bg-white selection:text-black relative">
      ...
      <main className="grid grid-cols-1 lg:grid-cols-2 h-screen overflow-hidden overflow-x-hidden">
            ...
            <div className="space-y-6 sm:space-y-8">
              <div>
                <h1 className="text-base sm:text-lg lg:text-xl font-light tracking-tighter uppercase font-mono mb-2 sm:mb-3">
                  Release <br />{" "}
                  <span className="bg-white text-black px-1 py-0 rounded-none">Version 1.1.0</span>
                </h1>
                ...
                <p className="text-[11px] sm:text-sm lg:text-xs font-light text-white/90 leading-relaxed font-mono uppercase mb-3 sm:mb-4">
                  <span>{"// "}</span> Better Auth Studio now supports 10 major web frameworks with
                  seamless integration for production deployments along with bunch of configuration
                ...
                <div className="space-y-2 sm:space-y-2.5 font-sans">
                  <div>
                    <p className="text-[11px] sm:text-xs lg:text-sm leading-relaxed text-white/80 font-light">
                      ...
                      We've expanded Better Auth Studio to support 10 major web frameworks including
                      Next.js, Express, Hono, Elysia, SvelteKit, SolidStart, TanStack Start, Astro,
                      Remix, and Nuxt. Each framework adapter provides framework-specific route
                      handlers, type-safe configuration, and seamless integration with Better Auth.
                    </p>
                  </div>
                  <div className="w-full mb-3 sm:mb-4 lg:hidden">
                    <hr className="w-full border-white/15 h-px" />
                  ...
                  <div>
                    <p className="text-[11px] sm:text-xs lg:text-sm leading-relaxed text-white/80 font-light">
                      ...
                      Framework-agnostic self-hosting allows you to deploy Better Auth Studio
                      alongside your application. Configure role-based access control and email
                      allowlists for secure admin access. Use environment variables for basePath and
                  ...
                  <div>
                    <p className="text-[11px] sm:text-xs lg:text-sm leading-relaxed text-white/80 font-light">
                      ...
                      Complete metadata support including custom titles, logos, favicons, company
                      branding, theme customization, and custom CSS styles. Replace the default
                      "Better Auth Studio" branding with your own company identity throughout the
                      interface.
                    </p>
                  </div>
                  <div className="w-full mb-3 sm:mb-4 lg:hidden">
              ...
              <div className="lg:hidden relative bg-[#0A0A0A] border-t border-white/15 -mx-4 sm:-mx-6 lg:mx-0 mt-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 border-b border-white/15 divide-x divide-y divide-white/15">
                  {frameworks.map((framework) => {
                    ...
                    return (
                      <div
                        key={framework.name}
                        className="p-3 sm:p-4 flex flex-col items-center justify-center gap-1.5 sm:gap-2 grayscale opacity-60 cursor-default"
                      >
                ...
                <div className="mt-4 mb-4 sm:mt-6 px-4 sm:px-6 pb-4">
                  <p className="text-[10px] sm:text-xs font-semibold leading-snug font-mono uppercase text-white">
                    ...
                    <span className="bg-white text-black px-1 py-0 rounded-none">Studio</span>{" "}
        ...
        <section className="hidden lg:flex flex-col justify-between relative bg-[#0A0A0A] overflow-hidden h-full">
          <div
            className="grow hidden md:flex items-center justify-center shrink-0 relative z-10"
            style={{ height: "60%" }}
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 border-t border-white/15 divide-x divide-y divide-white/15">
              {frameworks.map((framework) => {
                ...
                return (
                  <div
                    key={framework.name}
                    className="p-3 lg:p-4 flex items-center justify-center gap-2 grayscale hover:grayscale-0 transition-all opacity-60 hover:opacity-100 cursor-default"
                  >
