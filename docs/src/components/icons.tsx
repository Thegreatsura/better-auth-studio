...
export const NuxtIcon = ({ className = "w-3 h-3 inline-flex" }: IconProps) => (
  ...
  >
    <path
      d="M12.001 0L9.998 1.872l2 1.888 2.003-1.888L12.001 0zm-2.27 4.216L7.73 6.09l2.001 1.888 2.003-1.888-2.003-1.874zm4.538 0l-2.001 1.874 2.003 1.888 2.001-1.888-2.003-1.874zM6.464 7.206L4.46 9.08l2.002 1.888 2.003-1.888-2.003-1.874zm11.074 0l-2.003 1.874 2.003 1.888 2.001-1.888-2.001-1.874zM12 10.4l-2.001 1.874 2.001 1.888 2.003-1.888L12 10.4zm-5.536 3.09l-2.002 1.874 2.002 1.888 2.003-1.888-2.003-1.874zm11.074 0l-2.003 1.874 2.003 1.888 2.001-1.888-2.001-1.874zM12.001 17.6l-2.001 1.874 2.001 1.888 2.003-1.888-2.003-1.874zm-2.27 3.184l-2.002 1.874 2.003 1.888 2.001-1.888-2.002-1.874zm4.538 0l-2.001 1.874 2.003 1.888 2.001-1.888-2.003-1.874z"
      fill="currentColor"
    />
  </svg>
);
