...
export const TanStackStartIcon = ({ className = "w-3 h-3 inline-flex" }: IconProps) => (
  ...
  >
    <path
      fill="currentColor"
      d="M12 2L2 7v10l10 5 10-5V7L12 2zm0 2.18l8 4v8.64l-8 4-8-4V8.18l8-4z"
    />
    <path
      fill="currentColor"
      d="M12 6.5L6 9.5v5l6 3 6-3v-5l-6-3zm0 2.18l3.82 1.91v3.82L12 15.68l-3.82-1.91V10.59L12 8.68z"
    />
  </svg>
);
