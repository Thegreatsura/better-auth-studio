        ...
        {navItems.map((item) => (
          <li key={item.name} className="relative">
            ...
            >
              {item.name}
              <span
                className={`${hoveredItem === item.name ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-1"}`}
              >
                <ChevronUpRight />
              </span>
            </Link>
        ...
        {navItems.map((item) => (
          <li key={item.name}>
            ...
            >
              {item.name}
              <span
                className={`transition-all duration-300 ${hoveredItem === item.name ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-2"}`}
              >
                <ChevronUpRight />
              </span>
            </Link>
