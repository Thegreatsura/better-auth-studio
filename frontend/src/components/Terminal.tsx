...
export function Terminal({
  ...
  return (
    <div
      className={`bg-black/90 border border-dashed border-white/20 rounded-none font-mono text-xs ${className}`}
    >
      {/* Terminal Header */}
          ...
          {lines.length === 0 ? (
            ...
            lines.map((line) => (
              ...
              >
                ...
                <div className="flex-shrink-0 mt-0.5">{getLineIcon(line)}</div>
